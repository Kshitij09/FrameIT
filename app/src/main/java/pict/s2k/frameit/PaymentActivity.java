...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((AppCompatEditText) findViewById(R.id.name)).setText(FirebaseAuth.getInstance().getCurrentUser().getDisplayName());
        ((AppCompatEditText) findViewById(R.id.email)).setText(FirebaseAuth.getInstance().getCurrentUser().getEmail());
        ((AppCompatEditText) findViewById(R.id.phone)).setText(FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber());
        ((AppCompatEditText) findViewById(R.id.amount)).setText(intent.getStringExtra("price"));
        ((AppCompatEditText) findViewById(R.id.description)).setText("Paintings");
