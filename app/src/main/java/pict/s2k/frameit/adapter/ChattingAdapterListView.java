...
public class ChattingAdapterListView extends ArrayAdapter<MessageModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (messageModel != null) {
            ...
            parentView = v;
            chatStringLeft = v.findViewById(R.id.chatting_left).findViewById(R.id.chatting_text_left);
            chatStringRight = v.findViewById(R.id.chatting_right).findViewById(R.id.chatting_text_right);
