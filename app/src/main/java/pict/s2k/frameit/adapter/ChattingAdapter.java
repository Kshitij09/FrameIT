...
public class ChattingAdapter extends RecyclerView.Adapter<ChattingAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            parentView = view;
            chatStringLeft = view.findViewById(R.id.chatting_left).findViewById(R.id.chatting_text_left);
            chatStringRight = view.findViewById(R.id.chatting_right).findViewById(R.id.chatting_text_right);
